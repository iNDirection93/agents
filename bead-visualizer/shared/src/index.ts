...
export const EDGE_KINDS: readonly EdgeKind[] = Object.freeze([
  'blocks',
  'parent-child',
  'discovered-from',
  'related',
...
export const RANKING_EDGE_KINDS: readonly EdgeKind[] = Object.freeze(['blocks', 'parent-child']);
...
export type ServerEvent =
  | { type: 'hello'; source: 'bd' | 'fixture' }
  | { type: 'beads-changed'; at: string }
  | { type: 'purge-progress'; sessionId: string; step: PurgeStep };
